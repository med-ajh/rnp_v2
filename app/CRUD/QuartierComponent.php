...
class QuartierComponent implements CRUDComponent
{   
    public $create = true;
    public $delete = true;
    public $update = true;
    ...
    {
        return Quartier::class; // Return the Pachalik model
    }
    ...
    {
        $pachalikOptions = getCrudConfig('quartier')->inputs()['pachalik_id']['select'];
        return [
            'name' => 'text',
