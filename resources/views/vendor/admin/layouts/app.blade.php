        ...
        <nav class="navbar top-navbar navbar-expand-md">
            <div class="navbar-header" data-logobg="skin6">
                ...
                <div class="navbar-brand">
                    <a href="@route(getRouteName().'.home')" class="logo-link">
                        <img src="{{ asset('assets/images/logo.png') }}" id="logo-img" width="180">
                    </a>
                ...
                <script>
                    const darkModeCheckbox = document.getElementById('dark-switch');
                    const logoImg = document.getElementById('logo-img');
                
                    darkModeCheckbox.addEventListener('change', function() {
                        if (this.checked) {
                            // Dark mode akhawa
                            logoImg.src = "{{ asset('assets/images/logow.png') }}";
                        } else {
                            // Light mode a primo 
...
<!-- End Left Sidebar -->
    ...
    <div class="page-wrapper">
        ...
        <!-- footer -->
        <footer class="footer text-center text-muted">LiveWire Dashboard Template, By<a href="https://github.com/med-ajh"> Med_Ajh</a> .</footer>
        <!-- End footer -->
    </div>
</div>
<!-- End Wrapper -->
